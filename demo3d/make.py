...
pyc.Compile("start","","obj",["voxel_demo.cpp","Polygon.cpp","Camera.cpp","CameraControl.cpp", "Tetragon.cpp", "Shader.cpp","GameObject.cpp","AABB.cpp","World.cpp"],["epiclib"],3,0,pyc.CPPOX,["../"],["../"])
